...
% Last Modified by GUIDE v2.5 23-Aug-2018 22:47:41
...
for i=1:1:rol
    for j=1:1:col
        if R-det<=im(i,j,1) && im(i,j,1)<=R+det && G-det<=im(i,j,2) && im(i,j,2)<=G+det && B-det<=im(i,j,3) && im(i,j,3)<=B+det
            newim(i,j,1)=1;
            newim(i,j,2)=1;
            newim(i,j,3)=1;
        end
